  ...
  render() {
    return (
      <div className='container my-3'>
        <h2>Digital news - top headline</h2>
        <div className="row">
        {this.state.articles.map((element) =>{
           return <div className="col-md-4" key={element.url}> <Newsitem  title={element.title.slice(0, 77)} description={element.description.slice(0, 66)} imageurl={element.urlToImage} newsUrl={element.url} />
            </div>   
        })}
